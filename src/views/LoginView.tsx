    ...
    const handleMemberLogin = async () => {
        ...
        try {
            const payload = {
                ...
                password: selectedProfile.is_minor ? undefined : password,
            };
                    ...
                    >
                        ...
                        {selectedProfile?.is_minor ? (
                            ...
                            <>
                                <input
                                    type="password"
                                    className="w-full bg-[var(--color-surface)] text-[var(--color-text-primary)] border border-[var(--color-border-strong)] rounded-2xl h-14 px-5 text-[15px] focus:outline-none focus:ring-2 focus:ring-[var(--color-gold)]/50 focus:border-[var(--color-gold)] transition-all mb-6"
                                    ...
                                    autoFocus
                                />
                                <Button size="lg" className="w-full" onClick={handleMemberLogin} disabled={isLoading || !password} isLoading={isLoading}>
